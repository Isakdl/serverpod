...
import 'database/database_migration_registry.dart' as _i21;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i21.DatabaseMigrationRegistry) {
      return _i21.DatabaseMigrationRegistry.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i21.DatabaseMigrationRegistry?>()) {
      return (data != null
          ? _i21.DatabaseMigrationRegistry.fromJson(data, this)
          : null) as T;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i21.DatabaseMigrationRegistry) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'DatabaseMigrationRegistry') {
      return deserialize<_i21.DatabaseMigrationRegistry>(data['data']);
    }
